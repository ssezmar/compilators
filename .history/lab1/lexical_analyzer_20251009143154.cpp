...
public:
    ...
    void saveToFile(const std::string& filename) {
        ...
        if (isMarkdown) {
            ...
            file << "\n---\n";
            file << "**Использованные методы:**\n";
            file << "- Расширяемый конечный автомат (9 баллов)\n";
            file << "- Хеширование для ключевых слов (5 баллов)\n";
            file << "- Бинарный поиск для операторов (5 баллов)\n";
            file << "- Обработка комментариев (+2 балла)\n";
            file << "\n**Итого: 21 балл**\n";
        } else {
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "\n=== АНАЛИЗ ЗАВЕРШЕН ===\n" << std::endl;
    std::cout << "Использованные методы:" << std::endl;
    std::cout << "• Расширяемый конечный автомат (9 баллов)" << std::endl;
    std::cout << "• Хеширование для ключевых слов (5 баллов)" << std::endl;
    std::cout << "• Бинарный поиск для операторов (5 баллов)" << std::endl;
    std::cout << "• Обработка комментариев (+2 балла)" << std::endl;
    std::cout << "Итого: 21 балл" << std::endl;
